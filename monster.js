...
function gsw_display() {
    ...
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/01_a.png" alt="">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 大劍`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/great-sword_ic.png"
    ...
    for (var i = 0; i < 3; i++) {
        ...
        control_img.src = "/monster/img/2.png"
    ...
    <video src="/monster/video/大劍真續.mov" class="playvideo gsw_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/大劍相殺.mov" class="playvideo gsw_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/大劍角力.mov" class="playvideo gsw_tvideo off" loop="true"
        controls></video>`
...
function lsw_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/02_b.png" alt="" style="top: 20%; width:220%;left:-80%">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 太刀`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/long-sword_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/太刀看破.mov" class="playvideo lsw_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/太刀燈籠.mov" class="playvideo lsw_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/太刀居合.mov" class="playvideo lsw_tvideo off" loop="true"
        controls></video>`
...
function sw_shield_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/03_a.png" alt="">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 單手劍`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/sword-and-shield_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/片手腳立.mov" class="playvideo sw_shield_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/片手烙下攻擊.mov" class="playvideo sw_shield_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/片手滑布斬.mov" class="playvideo sw_shield_tvideo off" loop="true"
        controls></video>`
...
function db_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/04_a.png" alt="">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 雙刀`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/dual-blades_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/雙刀傷口.mov" class="playvideo db_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/雙刀蘭鬼人.mov" class="playvideo db_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/雙刀亂舞.mov" class="playvideo db_tvideo off" loop="true"
        controls></video>`
...
function hammer_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/05_b.png" alt="" style="width:140%;left:-20%">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 大錘`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/hammer_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/大槌相殺.mov" class="playvideo hammer_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/大槌轉圈圈.mov" class="playvideo hammer_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/大槌轉圈圈蓄力.mov" class="playvideo hammer_tvideo off" loop="true"
        controls></video>`
...
function hh_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/06_a.png" alt="" style="width:200%;left:-70%;top:15%">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 狩獵笛`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/hunting-horn_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/狩獵迪傷口.mov" class="playvideo hh_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/狩獵迪演奏.mov" class="playvideo hh_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/狩獵迪連消代打.mov" class="playvideo hh_tvideo off" loop="true"
        controls></video>`
...
function lance_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/07_a.png" alt="" style="width:175%;top:20%">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 長槍`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/lance_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/長槍火車.mov" class="playvideo lance_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/長槍反擊.mov" class="playvideo lance_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/長槍角力.mov" class="playvideo lance_tvideo off" loop="true"
        controls></video>`
...
function glance_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/08_a.png" alt=""style="width:200%;top:20%">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 銃槍`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/gunlance_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/銃槍全彈.mov" class="playvideo glance_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/銃槍龍及.mov" class="playvideo glance_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/銃槍角力.mov" class="playvideo glance_tvideo off" loop="true"
        controls></video>`
...
function switchaxe_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/09_a.png" alt="" style="width:200%;top:-5%">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 斬擊斧`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/switch-axe_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/斬擊斧 連消代打.mov" class="playvideo switchaxe_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/斬擊斧 完全解放.mov" class="playvideo switchaxe_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/斬擊斧 零解.mov" class="playvideo switchaxe_tvideo off" loop="true"
        controls></video>`
...
function cb_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/10_a.png" alt="" style="width:200%;top:10%;left:-60%">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 充能斧`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/charge-blade_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/充能斧 高解.mov" class="playvideo cb_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/充能斧 超解.mov" class="playvideo cb_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/充能斧 角力.mov" class="playvideo cb_tvideo off" loop="true"
        controls></video>`
...
function bugstick_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/11_a.png" alt="" style="width:195%;top:5%;left:-40%">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 操蟲棍`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/insect-glaive_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/操蟲棍 連消代打.mov" class="playvideo bugstick_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/操蟲棍 飛天螺旋.mov" class="playvideo bugstick_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/操蟲棍 空中舞踏.mov" class="playvideo bugstick_tvideo off" loop="true"
        controls></video>`
...
function lbowgun_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/12_a.png" alt="">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 輕弩`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/light-bowgun_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/輕弩 速射.mov" class="playvideo lbowgun_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/輕弩 起爆.mov" class="playvideo lbowgun_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/輕弩 黏卓.mov" class="playvideo lbowgun_tvideo off" loop="true"
        controls></video>`
...
function hbowgun_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/13_a.png" alt="" style="width:195%;top:35%;left:-20%;transform:rotate(10deg)">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 重弩`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/heavy-bowgun_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/重弩 角力.mp4" class="playvideo hbowgun_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/重弩 熱龍機關.mov" class="playvideo hbowgun_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/重弩 鳥上.mp4" class="playvideo hbowgun_tvideo off" loop="true"
        controls></video>`
...
function bow_display() {
    ...
    weaponbox.classList.remove("off")
    weapon_display.classList.remove("off")
    solider.innerHTML = `<img id="soliderimg" src="/monster/img/14_b.png" alt="" style="width:150%;top:-22%;left:-11%">`
    lefttitle.innerHTML = `<img id="weapon_ic" src="" alt=""> 弓`
    var weapon_ic = document.getElementById("weapon_ic")
    weapon_ic.src = "/monster/img/bow_ic.png"
    ...
    <h5 class="followvideo">特色演示只有武器的部分動作展示而已</h5>
    <h5 class="followvideo">還有很多動作可以到遊戲操作</h5>
    <video src="/monster/video/弓 蓄力墊步.mp4" class="playvideo bow_fvideo off" loop="true"
        controls></video>
    <video src="/monster/video/弓 誘導.mp4" class="playvideo bow_svideo off" loop="true"
        controls></video>
    <video src="/monster/video/弓 龍之見.mp4" class="playvideo bow_tvideo off" loop="true"
        controls></video>`
